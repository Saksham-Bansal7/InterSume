...
import { Award, Clock, Edit, Trash2, TrendingUp, Zap,Check} from "lucide-react";
    ...
    <div className={'group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden cursor-pointer transition-all duration-500 hover:scale-105 hover:shadow-lg rounded-3xl' + (isSelected ? ' border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50' : ' border-gray-200 hover:border-violet-300')} onClick={onSelect}>
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
          <img src={thumbnailImg || '/placeholder.svg'} alt="Template review" className="object-cover w-full h-full group-hover:scale-100 transition-transform duration-700" />
